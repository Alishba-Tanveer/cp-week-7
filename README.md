...
* [x] Week 7 repository setup
* [ ] `DESIGN.md`
* [ ] ERD with all seven entities
* [ ] Layered architecture description
* [ ] Create Task request flow
* [ ] Non-functional design
* [ ] At least three architectural trade-offs
* [ ] `api-spec.md`
* [ ] Tasks API specification
* [ ] Users API specification
* [ ] Projects API specification
* [ ] Project members API specification
...
* [ ] `ADR-001.md`
* [ ] Open Pull Request for each assignment

### Optional Challenge Work

* [ ] Sequence diagram
* [ ] State management subsection
* [ ] Denormalized field design
* [ ] Idempotent create endpoint
* [ ] Complete status-code table
* [ ] OpenAPI 3.1 specification
* [ ] `ADR-002.md`
* [ ] ADR expiry/reversal condition

---

## Consistency Requirements

All three documents must remain consistent with each other.

The following must match across the documentation:
...
The fixed domain must not be replaced with a different schema.